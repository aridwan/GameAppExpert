...
public class FavoritesProvider {
  ...
  public func getGame(by id: Int) -> Observable<Game> {
    return Observable<Game>.create { observer in
      let taskContext = self.newTaskContext()
      taskContext.perform {
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "Favorites")
  ...
  public func createFavorites(id: Int, name: String, releasedDate: String, rating: Double, added: Int, esrbRating: String, descriptionRaw: String, backgroundImage: String, image: Data) -> Observable<Bool> {
  ...
  public func deleteFavorites(_ id: Int) -> Observable<Bool> {
    return Observable<Bool>.create { observer in
      let taskContext = self.newTaskContext()
      taskContext.perform {
